...
/**
    BlockVax Token URI JSON Schema

    {
        ...
        "properties": {
            "address": {
                "type": "address",
                "description": "0xb0ddaB81da943DB847F5C8C8c15ea519De018A9A"
            },
            "patient ID": {
                "type": "uint",
                "description": "1"
            ...
            "Photo URI": {
                "type": "string",
                "description": "ipfs://bafybeigdphk2gou7s2nt7t4utp4jpcuhcrcpbnn2wrpws5xxqf6x364axi"
            }
        }
    }
...
contract blockVax is ERC721Full {
    ...
    function registerProvider (address addr, uint patientId, string memory vaxName, string memory VAX_uri) 
        public 
        onlyRegisteredProvider (vaxName, patientId)
    {
        ...
        _setTokenURI(patientId, VAX_uri);
    }
    ...
    {
        if (vaccinations[patientId].provider.vaccineName = vaxName) {
            return success;
        }
